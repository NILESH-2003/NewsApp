...
const News = (props) => {
  ...
  const updateNews = async () => {
    ...
    console.log();
    let url = `https://newsapi.org/v2/top-headlines?country=${props.country}&q=${props.keyword}&category=${props.category}&apiKey=5349930903e64df0980787b7f0ec64ae&page=${page}&pagesize=${props.pageSize}`;
    setloading(true);
